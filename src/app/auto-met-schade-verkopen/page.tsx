...
export const metadata: Metadata = {
  ...
  description:
    "Verkoop uw auto met schade voor de beste prijs aan Van Velzen Autorecycling. ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking.",
  keywords:
    "auto met schade verkopen, beschadigde auto verkopen, auto met schade, auto met schade verkopen prijs, auto met schade inruilen, auto met schade taxatie",
  alternates: {
    canonical: "/auto-met-schade-verkopen",
  },
  openGraph: {
    title: "Auto met schade verkopen | Hoogste prijs | Van Velzen Autorecycling",
    description:
      "Verkoop uw auto met schade voor de beste prijs aan Van Velzen Autorecycling. ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking.",
    url: "/auto-met-schade-verkopen",
    type: "website",
    images: [
      {
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Auto met schade verkopen? Ontvang de beste prijs bij Van Velzen Autorecycling
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Heeft u een auto met schade die u wilt verkopen? Bij Van Velzen Autorecycling krijgt u altijd een eerlijke
            en marktconforme prijs voor uw beschadigde voertuig.
          </p>
          <div className="mt-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
              Maximale waarde voor uw auto met schade
            </h2>
            <p className="text-gray-700 mb-4">
              Of het nu gaat om lichte of zware schade, een auto met schade na een ongeluk of als een auto total loss is
              verklaard - bij Van Velzen Autorecycling kopen wij alle auto's met schade aan tegen de hoogst mogelijke
              vergoeding. Onze experts beoordelen uw voertuig op basis van de actuele marktwaarde, herbruikbare
              onderdelen en materialen, zodat u altijd een eerlijke prijs ontvangt.
            </p>
            <p className="text-gray-700 mb-4">
              Wij begrijpen dat het verkopen van een auto met schade een stressvolle ervaring kan zijn. Daarom maken wij
              het proces zo eenvoudig en transparant mogelijk, met snelle afhandeling en gratis ophaalservice in heel
              Nederland.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw auto met schade verkopen aan Van Velzen Autorecycling?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✅</span>
                <p className="text-gray-700">
                  <span className="font-semibold">Top prijs voor beschadigde auto's</span> – Wij bieden de hoogst
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Welke auto's met schade kopen wij aan?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Hoe werkt het verkopen van uw auto met schade?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Binnen 2 uur een eerlijk bod op uw auto met schade.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Wat bepaalt de waarde van uw auto met schade?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✔</span>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Veelgestelde vragen over auto met schade verkopen
            </h2>
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-lg mb-2">Hoe snel kan ik mijn auto met schade verkopen?</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="font-bold text-lg mb-2">Moet ik mijn auto met schade eerst laten keuren?</h3>
                <p className="text-gray-700">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Ja, wij rekenen nooit kosten voor het ophalen van uw auto met schade, ongeacht uw locatie in
                  Nederland.
                </p>
              </div>
              <div>
        ...
        <div className="lg:col-span-1">
          ...
          <div id="offerte" className="bg-gray-100 rounded-lg p-6 mb-8 sticky top-24">
            <h3 className="text-xl font-bold mb-4 text-blue-800">Bereken wat uw auto met schade waard is</h3>
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          Bij Van Velzen Autorecycling zorgen we voor een zorgeloze ervaring bij het verkopen van uw auto met schade.
