...
export const metadata: Metadata = {
  title: "Beschadigde auto verkopen | Hoogste prijs | Van Velzen Autorecycling",
  description:
    "Verkoop uw beschadigde auto voor de beste prijs aan Van Velzen Autorecycling. ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking.",
  keywords:
    "beschadigde auto verkopen, auto met schade verkopen, total loss auto verkopen, ongeluksauto verkopen, schadeauto verkopen, auto recycling, rdw vrijwaring",
  alternates: {
    canonical: "/beschadigde-auto-verkopen",
  },
  openGraph: {
    title: "Beschadigde auto verkopen | Hoogste prijs | Van Velzen Autorecycling",
    description:
      "Verkoop uw beschadigde auto voor de beste prijs aan Van Velzen Autorecycling. ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking.",
    url: "/beschadigde-auto-verkopen",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Beschadigde Auto Verkopen bij Van Velzen Autorecycling",
      },
    ],
  },}

export default function BeschadigdeAutoVerkopen() {
  return (
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Beschadigde auto verkopen? Ontvang de beste prijs bij Van Velzen Autorecycling
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Heeft u een beschadigde auto die u wilt verkopen? Bij Van Velzen Autorecycling krijgt u altijd een eerlijke
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              ...
              verklaard - bij Van Velzen Autorecycling kopen wij alle beschadigde auto's aan tegen de hoogst mogelijke
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw beschadigde auto verkopen aan Van Velzen Autorecycling?
            </h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Welke beschadigde auto's kopen wij aan?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Hoe werkt het verkopen van uw beschadigde auto?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Binnen 2 uur een eerlijk bod op uw beschadigde auto.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Wat bepaalt de waarde van uw beschadigde auto?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✔</span>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Veelgestelde vragen over beschadigde auto verkopen
            </h2>
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-lg mb-2">Hoe snel kan ik mijn beschadigde auto verkopen?</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="font-bold text-lg mb-2">Moet ik mijn beschadigde auto eerst laten keuren?</h3>
                <p className="text-gray-700">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Ja, wij rekenen nooit kosten voor het ophalen van uw beschadigde auto, ongeacht uw locatie in
                  Nederland.
                </p>
              </div>
              <div>
        ...
        <div className="lg:col-span-1">
          ...
          <div id="offerte" className="bg-gray-100 rounded-lg p-6 mb-8 sticky top-24">
            <h3 className="text-xl font-bold mb-4 text-blue-800">Bereken wat uw beschadigde auto waard is</h3>
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          Bij Van Velzen Autorecycling zorgen we voor een zorgeloze ervaring bij het verkopen van uw beschadigde auto.
