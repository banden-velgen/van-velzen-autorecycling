...
export const metadata: Metadata = {
  ...
  description:
    "Ontdek de waarde van uw schadeauto bij Van Velzen Autorecycling. Eerlijke prijsbepaling op basis van schade, onderdelen en metaalwaarde. Vraag nu uw vrijblijvende offerte aan!",
  keywords: [
    "schadeauto waarde",
    "hoeveel geld voor schadeauto",
    "schadeauto verkopen prijs",
    "waarde beschadigde auto",
    "schadeauto taxatie",
  ],
  alternates: {
    canonical: "https://www.vanvelzenautorecycling.nl/hoeveel-geld-krijg-ik-voor-mijn-schadeauto",
  },
  openGraph: {
    title: "Hoeveel geld krijg ik voor mijn schadeauto? | Van Velzen Autorecycling",
    description:
      "Ontdek de waarde van uw schadeauto bij Van Velzen Autorecycling. Eerlijke prijsbepaling op basis van schade, onderdelen en metaalwaarde.",
    url: "https://www.vanvelzenautorecycling.nl/hoeveel-geld-krijg-ik-voor-mijn-schadeauto",
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoeveel geld krijg ik voor mijn schadeauto?
          </h1>
        ...
        <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-700">
                  ...
                  aluminium en andere metalen hebben direct invloed op wat uw schadeauto waard is.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 md:col-span-2">
                <div className="flex items-start mb-3">
                  ...
                  <h3 className="text-xl font-semibold">Algemene staat en type schade</h3>
                </div>
                <p className="text-gray-700">
                  Rijdt de auto nog? Wat voor type schade heeft de auto (carrosserie, motor, water, brand)? De aard en
                  omvang van de schade heeft grote invloed op de restwaarde van uw voertuig. Een auto die nog rijdt is
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 relative">
                ...
                <p className="text-gray-700">
                  U geeft informatie over uw schadeauto door via ons formulier, telefonisch of per e-mail.
                </p>
              </div>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 relative">
                ...
                <p className="text-gray-700">
                  Onze experts analyseren de gegevens en beoordelen de aard en omvang van de schade.
                </p>
              </div>
          ...
          <div className="mb-10">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Wat als mijn auto nog rijdt ondanks de schade?</h3>
                <p className="text-gray-700">
                  Dit kan de waarde positief beïnvloeden. Een rijdende schadeauto heeft vaak meer waarde omdat de
                  onderdelen nog functioneren en getest kunnen worden. Geef dit duidelijk aan bij uw aanvraag.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Ook total loss verklaarde auto's kopen wij graag in. Vaak bieden wij een betere prijs dan wat u via de
                  verzekeraar zou krijgen voor het wrak. Wij nemen ook alle administratieve afhandeling voor onze
                  rekening.
                </p>
              </div>
            </div>
