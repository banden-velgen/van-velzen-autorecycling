...
export const metadata: Metadata = {
  title: "Hoeveel geld krijg ik voor mijn sloopauto? | Vraag direct een offerte aan",
  description:
  ...
  alternates: {
    canonical: "https://www.vanvelzenautorecycling.nl/hoeveel-geld-krijg-ik-voor-mijn-sloopauto",
  },
  openGraph: {
    title: "Hoeveel geld krijg ik voor mijn sloopauto? | Van Velzen Autorecycling",
    description:
    ...
    url: "https://www.vanvelzenautorecycling.nl/hoeveel-geld-krijg-ik-voor-mijn-sloopauto",
    siteName: "Van Velzen Autorecycling",
    locale: "nl_NL",
    type: "website",
  },}

export default function HoeveelGeldKrijgIkVoorMijnSloopautoPage() {
  return (
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoeveel geld krijg ik voor mijn sloopauto?
          </h1>
