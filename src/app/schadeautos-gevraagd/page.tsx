...
export const metadata: Metadata = {
  title: "Schadeauto's gevraagd | Hoogste prijs | Van Velzen Autorecycling",
  description:
    "Wij kopen uw schadeauto tegen top prijzen! ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking. Vraag nu een offerte aan.",
  keywords:
    "schadeautos gevraagd, schadeauto verkopen, auto recycling, beschadigde auto verkopen, kapotte auto verkopen, rdw vrijwaring, gratis schadeauto ophalen",
  alternates: {
    canonical: "/schadeautos-gevraagd",
  },
  openGraph: {
    title: "Schadeauto's gevraagd | Hoogste prijs | Van Velzen Autorecycling",
    description:
      "Wij kopen uw schadeauto voor een top prijs! ✓ Gratis ophalen ✓ Directe betaling ✓ RDW-vrijwaring ✓ Landelijke dekking. Vraag nu een offerte aan.",
    url: "/schadeautos-gevraagd",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Schadeauto's gevraagd bij Van Velzen Autorecycling",
      },
    ],
  },
}

export default function SchadeautoGevraagd() {
  return (
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Schadeauto's gevraagd - Beste prijs bij Van Velzen Autorecycling
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Wij kopen dagelijks schadeauto's op in heel Nederland! Of uw auto nu rijdt of niet, beschadigd is of gewoon
        ...
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
              Wij zijn op zoek naar schadeauto's in heel Nederland
            </h2>
            <p className="text-gray-700 mb-4">
              Bij Van Velzen Autorecycling zijn wij continu op zoek naar schadeauto's voor recycling en onderdelen. Wij
              bieden een professionele en milieuvriendelijke oplossing voor uw beschadigde, kapotte of aangereden auto,
            ...
            <p className="text-gray-700">
              Heeft u een auto met schade die niet meer de moeite waard is om te repareren? Of een voertuig dat door een
              ongeval beschadigd is? Wij zijn geïnteresseerd! Onze experts beoordelen uw auto op basis van de schade,
              herbruikbare onderdelen en actuele metaalprijzen om u de beste prijs te bieden.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw schadeauto aan ons verkopen?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
                <p className="text-gray-700">
                  <span className="font-semibold">Hoogste prijzen voor uw beschadigde auto</span> – Wij bieden
                  marktconforme prijzen gebaseerd op actuele metaalwaarden en herbruikbare onderdelen.
                </p>
              </div>
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Welke schadeauto's zijn wij op zoek naar?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
                <p className="text-gray-700">Auto's met aanrijdingsschade</p>
              </div>
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
                <p className="text-gray-700">Voertuigen met technische schade</p>
              </div>
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Ontvang binnen 2 uur een eerlijke prijsindicatie voor uw schadeauto.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✓</span>
                <div>
                  <p className="font-semibold text-gray-800">Type en omvang van de schade</p>
                  <p className="text-gray-700">
                    De aard en ernst van de schade heeft grote invloed op de restwaarde van uw auto.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-lg text-gray-800 mb-2">Hoe snel kan mijn schadeauto worden opgehaald?</h3>
                <p className="text-gray-700">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Ja, wij rekenen nooit kosten voor het ophalen van schadeauto's, ongeacht uw locatie in Nederland.
                </p>
              </div>
              <div>
