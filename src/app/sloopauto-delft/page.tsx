...
export const metadata: Metadata = {
  title: "Sloopauto Delft | Snel ophalen en beste prijs | Van Velzen Autorecycling",
  description:
    "Heeft u een sloopauto in Delft? ✓ Gratis afhalen ✓ Direct RDW vrijwaring ✓ Contant geld ✓ Milieuvriendelijke verwerking. Vraag direct een offerte aan!",
  keywords:
    "sloopauto delft, auto slopen delft, autowrak delft, kapotte auto delft, schadeauto delft, auto recycling delft, rdw vrijwaring delft, gratis auto ophalen delft",
  alternates: {
    canonical: "/sloopauto-delft",
  },
  openGraph: {
    title: "Sloopauto Delft | Snel ophalen en beste prijs | Van Velzen Autorecycling",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Sloopauto in Delft laten ophalen door Van Velzen Autorecycling",
      },
    ],
  },}

export default function SloopautoDelft() {
  return (
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Sloopauto verkopen in Delft? Snel en gratis laten ophalen door Van Velzen Autorecycling
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Wij halen alle soorten auto's op in Delft, ongeacht de staat – of deze nu nog rijdt of niet. Ontvang een
            eerlijke prijs en profiteer van onze gratis ophaalservice in Delft.
          </p>
          <div className="mt-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">Heeft u een sloopauto in Delft?</h2>
            <p className="text-gray-700 mb-4">
              Heeft u een sloopauto in Delft die u wilt laten ophalen? Bij Van Velzen Autorecycling krijgt u een snelle,
              eerlijke en transparante service. Wij zijn geïnteresseerd in alle auto's in Delft, of deze nu nog rijdt of
              niet, en wij bieden een concurrerend bod op basis van de huidige metaalprijzen en recyclebare onderdelen.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw sloopauto in Delft door ons laten ophalen?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✔</span>
                <p className="text-gray-700">
                  <span className="font-semibold">Gratis ophaalservice in heel Delft</span> – Wij komen uw auto
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Wij halen uw sloopauto gratis bij u op in Delft.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">Welke auto's halen wij op in Delft?</h2>
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          Bij Van Velzen Autorecycling zorgen we voor een zorgeloze ervaring bij het ophalen van uw sloopauto in Delft.
