...
export const metadata: Metadata = {
  title: "Sloopauto gratis inleveren | Hoogste prijs | Van Velzen Autorecycling",
  description:
    "Lever uw sloopauto gratis in bij Van Velzen Autorecycling. ✓ Ontvang een eerlijke prijs ✓ RDW-vrijwaring ✓ Zelf inleveren of gratis ophalen ✓ Milieuvriendelijke recycling.",
  keywords:
    "sloopauto gratis inleveren, auto recycling, sloopauto verkopen, schadeauto inleveren, schadeauto verkopen, auto slopen, rdw vrijwaring, auto inleveren, sloopauto prijs, milieuverantwoorde autosloop, autosloperij delft",
  alternates: {
    canonical: "/sloopauto-gratis-inleveren",
  },
  openGraph: {
    title: "Sloopauto gratis inleveren | Hoogste prijs | Van Velzen Autorecycling",
    description:
      "Lever uw sloopauto gratis in bij Van Velzen Autorecycling. ✓ Ontvang een eerlijke prijs ✓ RDW-vrijwaring ✓ Zelf inleveren of gratis ophalen ✓ Milieuvriendelijke recycling.",
    url: "/sloopauto-gratis-inleveren",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Sloopauto gratis inleveren bij Van Velzen Autorecycling",
      },
    ],
  },}

export default function SloopautoGratisInleveren() {
  return (
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <Image
          ...
          alt="Sloopauto gratis inleveren"
          width={1200}
          height={600}
        ...
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
              Ontvang de hoogste prijs voor uw sloopauto - Gratis inleveren
            </h2>
            <p className="text-gray-700 mb-4">
              Wilt u uw sloopauto gratis inleveren? Bij Van Velzen Autorecycling ontvangt u altijd de hoogste prijs voor
              uw oude voertuig, zonder enige kosten. Of u nu zelf komt of gebruik maakt van onze gratis ophaalservice -
              wij garanderen een correcte en milieuvriendelijke afhandeling.
            </p>
            <p className="text-gray-700">
              ...
              milieuvriendelijke manier wordt verwerkt volgens de strengste Europese normen - en dat alles zonder kosten
              voor u.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw sloopauto gratis inleveren bij Van Velzen Autorecycling?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Top prijs voor uw oude auto",
                "Volledig gratis inname zonder verborgen kosten",
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Hoe kunt u uw sloopauto gratis inleveren?
            </h2>

            {/* Zelf inleveren */}
            <div className="mb-6">
              <h3 className="text-xl font-bold mb-4 text-gray-800">1. Zelf gratis inleveren bij onze vestiging</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Stappenplan sloopauto gratis inleveren
            </h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
              Wat heeft u nodig bij gratis inleveren?
            </h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Veelgestelde vragen over sloopauto gratis inleveren
            </h2>
            <div className="space-y-4">
              {[
                {
                  question: "Is het inleveren van mijn sloopauto echt helemaal gratis?",
                  answer:
                    "Ja, het inleveren van uw sloopauto bij Van Velzen Autorecycling is volledig gratis. Er zijn geen verborgen kosten of voorwaarden. Wij verzorgen het hele proces kosteloos.",
                },
                {
                ...
                {
                  question: "Kan ik mijn auto zonder kentekenbewijs gratis inleveren?",
                  answer:
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Voordelen van gratis inleveren bij Van Velzen Autorecycling
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
        ...
        <div className="lg:col-span-1">
          ...
          <div id="offerte" className="bg-gray-100 rounded-lg p-6 mb-8 sticky top-24">
            ...
            <p className="text-gray-700 mb-6">
              ...
              Autorecycling regelen wij alles snel, eerlijk en milieuvriendelijk - en dat volledig gratis.
            </p>
            <QuoteForm />
          </div>
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-800">
          Klaar om uw sloopauto gratis in te leveren?
        </h2>
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          Neem vandaag nog contact op voor een vrijblijvende offerte en ontdek hoeveel uw auto waard is. Bij Van Velzen
          Autorecycling zorgen we voor een zorgeloze ervaring, de hoogste prijs, en dat alles zonder kosten.
        </p>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is het inleveren van mijn sloopauto echt helemaal gratis?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Ja, het inleveren van uw sloopauto bij Van Velzen Autorecycling is volledig gratis. Er zijn geen verborgen kosten of voorwaarden. Wij verzorgen het hele proces kosteloos.",
                },
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                name: "Kan ik mijn auto zonder kentekenbewijs gratis inleveren?",
                acceptedAnswer: {
                  "@type": "Answer",
