...
export const metadata: Metadata = {
  title: "Sloopauto Verkopen Baarn | Snel geld en gratis ophalen | Van Velzen Autorecycling",
  description:
    "Verkoop uw sloopauto in Baarn voor de beste prijs! ✓ Gratis afhalen ✓ Direct RDW vrijwaring ✓ Contant geld ✓ Milieuvriendelijk. Vraag nu een offerte aan!",
  keywords:
    "sloopauto verkopen Baarn, auto verkopen Baarn, autowrak verkopen Baarn, kapotte auto verkopen Baarn, schadeauto verkopen Baarn, auto recycling Baarn, rdw vrijwaring Baarn, gratis auto ophalen Baarn",
  alternates: {
    canonical: "/sloopauto-verkopen-baarn",
  },
  openGraph: {
    title: "Sloopauto Verkopen Baarn | Snel geld en gratis ophalen | Van Velzen Autorecycling",
    description:
      "Verkoop uw sloopauto in Baarn voor de beste prijs! ✓ Gratis afhalen ✓ Direct RDW vrijwaring ✓ Contant geld ✓ Milieuvriendelijk. Vraag nu een offerte aan!",
    url: "/sloopauto-verkopen-baarn",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Sloopauto verkopen bij Van Velzen Autorecycling in Baarn",
      },
    ],
  },
}

export default function SloopautoVerkopenBaarn() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <Image
          ...
          alt="Sloopauto verkopen in Baarn"
          width={1200}
          height={600}
        ...
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              Is uw auto aan het einde van zijn levensduur en zoekt u een betrouwbare partij om uw sloopauto in Baarn te
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw sloopauto in Baarn aan ons verkopen?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✔</span>
                <p className="text-gray-700">
                  <span className="font-semibold">Gratis afhalen in Baarn en omgeving</span> – Wij komen uw auto
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Wij halen uw sloopauto gratis bij u op in Baarn.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          Bij Van Velzen Autorecycling zorgen we voor een zorgeloze ervaring bij het verkopen van uw sloopauto in Baarn.
