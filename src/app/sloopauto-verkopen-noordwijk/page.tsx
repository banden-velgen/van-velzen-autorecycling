...
export const metadata: Metadata = {
  title: "Sloopauto Verkopen Noordwijk | Snel geld en gratis ophalen | Van Velzen Autorecycling",
  description:
    "Verkoop uw sloopauto in Noordwijk voor de beste prijs! ✓ Gratis afhalen ✓ Direct RDW vrijwaring ✓ Contant geld ✓ Milieuvriendelijk. Vraag nu een offerte aan!",
  keywords:
    "sloopauto verkopen Noordwijk, auto verkopen Noordwijk, autowrak verkopen Noordwijk, kapotte auto verkopen Noordwijk, schadeauto verkopen Noordwijk, auto recycling Noordwijk, rdw vrijwaring Noordwijk, gratis auto ophalen Noordwijk",
  alternates: {
    canonical: "/sloopauto-verkopen-noordwijk",
  },
  openGraph: {
    title: "Sloopauto Verkopen Noordwijk | Snel geld en gratis ophalen | Van Velzen Autorecycling",
    description:
      "Verkoop uw sloopauto in Noordwijk voor de beste prijs! ✓ Gratis afhalen ✓ Direct RDW vrijwaring ✓ Contant geld ✓ Milieuvriendelijk. Vraag nu een offerte aan!",
    url: "/sloopauto-verkopen-noordwijk",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Sloopauto verkopen bij Van Velzen Autorecycling in Noordwijk",
      },
    ],
  },}

export default function SloopautoVerkopenNoordwijk() {
  return (
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative rounded-lg overflow-hidden mb-12">
        ...
        <Image
          ...
          alt="Sloopauto verkopen in Noordwijk"
          width={1200}
          height={600}
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Sloopauto verkopen in Noordwijk? Snel en voordelig bij Van Velzen Autorecycling
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Wij zijn geïnteresseerd in alle auto's, ongeacht de staat – of deze nu nog rijdt of niet. Krijg een eerlijke
            prijs en gratis ophaalservice in Noordwijk.
          </p>
          <div className="mt-8">
        ...
        <div className="lg:col-span-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              ...
              Noordwijk te verkopen? Bij Van Velzen Autorecycling krijgt u een snelle, eerlijke en transparante
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-blue-800">
              Waarom uw sloopauto in Noordwijk aan ons verkopen?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                <span className="text-green-600 text-xl mr-2">✔</span>
                <p className="text-gray-700">
                  <span className="font-semibold">Gratis afhalen in Noordwijk en omgeving</span> – Wij komen uw auto
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700">Wij halen uw sloopauto gratis bij u op in Noordwijk.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
      ...
      <section className="mt-12 bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
          ...
          Noordwijk. Profiteer van onze jarenlange expertise en uitstekende service.
        </p>
      </section>
    </div>
  )
